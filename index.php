    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                            ...
                            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner" >
                                    <div class="item active" >
                                        <img src="images/mahalxmi.jpg" width="500%"  height="1000%">
                                    </div>
                                    <div class="item" >
                                        <img src="images/rankala1.jpg" width="100%">
                                    </div>
                                    <div class="item" >
                                        <img src="images/jotiba.jpg" width="100%" >
                                    </div>
                                    <div class="item" >
                                        <img src="images/tamdapandra.jpg" width="100%" >
                                    </div>
                                    <div class="item" >
                                        <img src="images/kolhapuri.jpg" width="100%" >
                                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="box">
                            <img src="images/web-muttonthali.jpg" width="100%"  height="30%">
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="box">
                            <img src="images/Kolhapuri-Cuisine.jpg" width="100%"  height="30%">
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="box">
                            <img src="images/thushi.jpg" width="100%"  height="30%">
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="box">
                            <img src="images/saaj.jpg" width="100%"  height="30%">
                        </div>
      ...
      <br>
                <div class="row">
                    <div class="col-md-4">
                        <div class="box">
                            <img src="images/Nauwari-saree.jpg" width="100%"  height="30%">
                        </div>
      ...
      <br>
                <div class="row">
                    <div class="col-md-4">
                        <div class="box">
                            <img src="images/Kolhapuri-cinema.jpg" width="100%"  height="30%">
                        </div>
